...
class Fatigue_detecting(wx.Frame):
    ...
    def _learning_face(self,event):
        ...
        self.predictor = dlib.shape_predictor("G:/pycharm project/python project/face detecting/model/shape_predictor_68_face_landmarks.dat")
        ...
        while(self.cap.isOpened()):
            ...
            print(timecost)
            if (self.TOTAL >= 50 or self.mTOTAL>=15 or self.hTOTAL>=30) and (timecost < 200):
